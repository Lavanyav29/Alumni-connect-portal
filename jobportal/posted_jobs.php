...
$posted_internships = $conn->prepare("SELECT * FROM job_postings WHERE posted_by = ?");
    ...
    <tbody>
        <?php while ($internship = $internships_result->fetch_assoc()): ?>
            <tr>
                ...
                <td><?php echo htmlspecialchars($internship['job_type']); ?></td>
                ...
                <td>
                    <a href="delete.php?type=job&id=<?php echo $internship['id']; ?>" class="btn" onclick="return confirm('Are you sure you want to delete this job?');">Delete</a>
                </td>
            </tr>
        <?php endwhile; ?>
    </tbody>
